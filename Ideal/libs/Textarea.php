 ...
 * @license GNU General Public License 2.0
 */
class Textarea_ideal extends Typecho_Widget_Helper_Form_Element
{
    ...
    public function __construct($name = NULL, array $options = NULL, $value = NULL, $label = NULL, $description = NULL)
    {
        ...
        $this->addItem(new Ideal('<div class="mdui-panel" mdui-panel=""><div class="mdui-panel-item"><div class="mdui-panel-item-header">'.$label. '</div><div class="mdui-panel-item-body"><ul style="padding-left: 0px; list-style: none!important" id="typecho-option-item-'.$name.'-'.self::$uniqueId.'">'));
    ...
    {
        $this->addItem(new Ideal('<div class="mdui-textfield">'));
